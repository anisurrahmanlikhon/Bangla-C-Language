...
- <b>```# অন্তর্ভুক্ত < স্ট্যান্ডার্ড_ইন_আউট.হেডার >```</b> হচ্ছে C language এ হেডার ফাইল. <b>```#include<stdio.h>```</b>
- <b>```পূর্ণ```</b> হলো <b>```int```</b> ও <b>```মৌলিক()```</b> হচ্ছে <b>```main()```</b> ফাংশন।
- <b>```দেখাও()```</b> হচ্ছে  <b>```printf()```</b> ফাংশন।
- <b>```ফেরত ০```</b> হচ্ছে  <b>```return 0```</b>
